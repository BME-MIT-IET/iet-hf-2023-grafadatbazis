...
/**
 * Agent osztályból származik, feladata a vitus tánc vírus hatásának
 * megakadályozása.
 */
public class VitusVaccine extends Agent {
	...
	/**
	 * Felülírja az Agent Round metódusát, ez hívódik meg amikor egy karakter aktív
	 * ágensei között el van tárolva,
