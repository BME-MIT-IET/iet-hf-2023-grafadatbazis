...
/**
 * Gear osztályból származik, felülírja ennek a metódusait, hogy a virológus
 * anyag hordó kapacitását megnövelje.
 */
public class Sack extends Gear {
	 ...
	 * karakterre kifejti a kapacitás növelő hatását.
	 */
	@Override
