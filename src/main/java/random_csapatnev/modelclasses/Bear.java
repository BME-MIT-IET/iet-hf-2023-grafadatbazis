...
public class Bear extends Character {
	...
	public void die() {
		...
		MainFrame.Instance.getModel().getCharacters().add(c);
		MainFrame.Instance.getModel().getGraphicsCharacter().add(new GraphicsDeadCharacter(c));
		...
		MainFrame.Instance.getModel().getCharacters().remove(this);
	}
}
